...
% ---- DCL / Yonsei background on every slide ----
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{figs/dcl_bg.png}}
...
% push title + content down into the white content box (below the logo header)
\setbeamertemplate{frametitle}{\vspace{12mm}\hspace{1mm}\insertframetitle\par\vspace{1mm}}
