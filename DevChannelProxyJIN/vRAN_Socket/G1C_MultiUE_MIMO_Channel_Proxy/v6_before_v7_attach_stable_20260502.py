"""
================================================================================
v6.py - G1C Multi-UE MIMO Channel Proxy (v6 + Comprehensive Bug Fixes)
...
[v6 →  변경사항]
  ...
  3. distance_3d: derived from P1B tau when available, else configurable
     (was: hardcoded ones)
...
class UnifiedChannelProducerProcess(_mp_ctx.Process):
    ...
    def run(self):
        ...
        # ─────────────────────────────────────────────────────────────────
        # v7 #V6-7: distance_3d — derive from P1B tau when available.
        # Each UE's first-tap (LOS or earliest) tau gives d ≈ c·tau.  Falls
        # back to a configurable scalar when no P1B data is supplied.
...
def main():
    ...
    ap.add_argument("--default-distance-m", type=float, default=100.0,
                    help="Default UE-BS distance (meters) when no P1B npz is "
                         "provided. With P1B, distance is derived from tau "
                         "and this flag is ignored. (v7 #V6-7)")
