...

{
  ...
  echo "# min_srs_frames: ${MIN_SRS_FRAMES:-<runner_default>}"
...
for method in $METHODS; do
  case "$method" in
    ewma|adaptive)
      ;;
    *)
      echo "ERROR: unsupported method '${method}' (allowed: ewma adaptive)"
      exit 1
      ;;
  esac
